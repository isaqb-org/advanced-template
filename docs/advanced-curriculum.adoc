...
ifeval::["{language}" == "EN"]
= Curriculum forpass:q[<br><br>]Certified Professional forpass:q[<br>]Software Architecture (CPSA)^®^pass:q[<br>]_Advanced Level_: pass:q[<br><br>]Modulepass:q[<br>]{curriculum-short}pass:q[<br><br>]{curriculum-name}
:toc: left
endif::[]
