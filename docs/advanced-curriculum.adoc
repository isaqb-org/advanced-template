...
= Curriculum fürpass:q[<br>]CPSA Certified Professional forpass:q[<br>]Software Architecture®pass:q[<br>]- Advanced Level -pass:q[<br>]pass:q[<br>]Modul:pass:q[<br>]{curriculum_short}pass:q[<br>]{curriculum_name}
