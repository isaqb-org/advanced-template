...
<<<
:sectnums:
include::01-module-lesson1/00-structure.adoc[{include_configuration}]

<<<
include::02-module-lesson2/00-structure.adoc[{include_configuration}]

<<<
include::03-module-lesson3/00-structure.adoc[{include_configuration}]

<<<
include::04-module-lesson4/00-structure.adoc[{include_configuration}]

<<<
include::05-module-lesson5/00-structure.adoc[{include_configuration}]
