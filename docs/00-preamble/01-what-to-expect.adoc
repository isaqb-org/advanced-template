...
// tag::DE[]
=== Was vermittelt eine Advanced-Schulung?
Lizenzierte Schulungen zum _Certified Professional for Software Architecture – Advanced Level_ (CPSA-A) vermitteln grundlegende Rechenkenntnisse.
