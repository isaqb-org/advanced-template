...
If you have Docker installed you can also use the Dockerfile from the adoc2pdf submodule.

First you have to build the container locally.

[source,shell]
----
   adoc2pdf/build-container.sh
----

Then you can execute the transformation.

[source,shell]
----
   adoc2pdf/adoc2pdf.sh /full/path/to/your/root/document.adoc
----
